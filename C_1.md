...
- **h*t = tanh(W_hh × h*{t-1} + W_xh × x_t + b_h):** W_hh brings forward memory, W_xh incorporates new input, b_h
  provides baseline
...
- x₁ = [1, 0, 0, 1] (embedding for "The")
- x₂ = [0, 1, 1, 0] (embedding for "cat")
- x₃ = [1, 1, 0, 0] (embedding for "sat")

###### Time Step 1: Processing "The"

**Initial state:** h₀ = [0, 0, 0]

**Step 1a - Core Equation:**

$$
h_1 = \tanh(W_{hh} \times h₀ + W_{xh} \times x₁ + b_h) \\

W_{hh} \times h₀ = \begin{bmatrix} 0.1 & 0.2 & 0.1 \\ 0.3 & 0.1 & 0.2 \\ 0.2 & 0.1 & 0.3 \end{bmatrix} \times \begin{bmatrix} 0 \\ 0 \\ 0 \end{bmatrix} = \begin{bmatrix} 0 \\ 0 \\ 0 \end{bmatrix} \\

W_{xh} \times x₁ = \begin{bmatrix} 0.3 & 0.1 & 0.2 & 0.4 \\ 0.2 & 0.4 & 0.1 & 0.3 \\ 0.1 & 0.2 & 0.3 & 0.2 \end{bmatrix} \times \begin{bmatrix} 1 \\ 0 \\ 0 \\ 1 \end{bmatrix} = \begin{bmatrix} 0.3 + 0.4 \\ 0.2 + 0.3 \\ 0.1 + 0.2 \end{bmatrix} = \begin{bmatrix} 0.7 \\ 0.5 \\ 0.3 \end{bmatrix} \\
...
Input: "The" Raw output: $[0.57, 0.57, 0.52, 0.36, 0.37]$ Softmax: $[0.22, 0.22, 0.21, 0.18, 0.18]$ Prediction: "dog"
(highest probability)

Input: "The cat" Raw output: $[0.69, 0.78, 0.72, 0.44, 0.62]$ Softmax: $[0.19, 0.21, 0.20, 0.15, 0.18]$ Prediction:
