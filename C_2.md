...
In the complete LSTM memory update equation: C*t = f_t ⊙ C*{t-1} + i_t ⊙ C̃_t

When f_t (forget gate) is close to 1, the network preserves old information. When i_t (input gate) is close to 1, the
network fully incorporates new information.
