...
increase, gradient magnitudes tend to decrease exponentially, severely slowing or halting learning. We can use the following models to solve the Vanishing Gradient Problem:
