...
```
Training Phase:
Sequence 1: Use W_hh = [0.1, 0.2; 0.3, 0.4] → Update to W_hh = [0.11, 0.19; 0.29, 0.41]
Sequence 2: Use W_hh = [0.11, 0.19; 0.29, 0.41] → Update to W_hh = [0.12, 0.18; 0.28, 0.42]
...
Final: W_hh = [0.5, 0.3; 0.2, 0.7]

Inference Phase:
All sequences: Always use final W_hh = [0.5, 0.3; 0.2, 0.7] (never changes)
```
